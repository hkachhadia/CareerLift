      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-slate-950/50 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/auth" className="text-sm font-medium bg-white text-slate-950 px-4 py-2 rounded-full hover:bg-slate-200 transition-colors">
              Get Started
            </Link>
          </div>
        </div>
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link to="/auth" className="w-full sm:w-auto px-8 py-4 bg-indigo-500 hover:bg-indigo-600 text-white rounded-full font-semibold flex items-center justify-center gap-2 transition-all shadow-[0_0_30px_-5px_rgba(99,102,241,0.4)]">
